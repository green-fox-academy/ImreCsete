...
int main()
{
    ...
    *low_number_pointer = temp;
    ...
    printf("high_number is %d, high_number_pointer is %d\n", high_number, *high_number_pointer);
    printf("low_number is %d, low_number_pointer is %d\n", low_number, *low_number_pointer);
